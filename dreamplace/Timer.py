...
class Timer(object):
    ...
    def __call__(self, params, placedb):
        ...
        logging.info("reading timer constraints takes %g seconds" % (time.time() - tt))
    ...
    def report_timing(self, n):
        ...
        return timing_cpp.report_timing(self.raw_timer, n, self.placedb.net_name2id_map)
