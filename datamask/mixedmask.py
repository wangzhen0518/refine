...
def hot_start(
    ...
    for i in range(stop_round):
        print(i)
        place_record, hpwl = mixed_placer(node_id_ls, placedb, grid_num, grid_size, place_record, m2m_flow, alpha=0.8, beta=0.2)
...
def main():
    ...
    hpwl_save_dir += "{}_seed_{}_mixedmask_iter.csv".format(dataset, seed1)
    placement_save_dir += "{}_seed_{}_mixedmask_iter.csv".format(dataset, seed1)
    ...
    m2m_flow = get_m2m_flow(m2m_flow_file)
    pic_save_dir += "{}_seed_{}_mixedmask_iter.png".format(dataset, seed1)
