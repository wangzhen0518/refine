                ...
                def one_descent_step(
                    ...
                    if (
                        ...
                        timing_op.update_net_weights(
                            max_net_weight=placedb.max_net_weight, n=npaths
                        )
                        ...
                        for Lsub_step in range(model.Lsub_iteration):
                            ...
                            if (
                                ...
                                if overflow_list[-1] > 0.9:  # stuck at high overflow
                                    ...
                                    logging.info(
                                        "Stuck at early stage. Turn on quadratic penalty with double density factor to accelerate convergence"
                                    )
                                    if (
